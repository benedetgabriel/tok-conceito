...
const ProductsMobile = () => {
  ...
  useEffect(() => {
    ...
    const scrollLeft =
      centeredButtonRef.current.offsetLeft -
      container.offsetWidth / 2 +
      centeredButtonRef.current.offsetWidth / 2;
        ...
        <div className={styles.container_images}>
          <div className={styles.imgs}>
            <div
              ...
              onClick={() =>
                openCarousel([Product1PA, Product2PA, Product3PA, Product4PA])
              }
            >
        ...
        <div className={styles.container_images}>
          <div className={styles.imgs}>
            <div
              className={styles.img}
              onClick={() =>
                openCarousel([ProductBoucle1, ProductBoucle2, ProductBoucle3])
              }
            >
            ...
            <div
              className={styles.img}
              onClick={() =>
                openCarousel([ProductGeo1, ProductGeo2, ProductGeo3])
              }
            >
          ...
          <div className={styles.imgs}>
            ...
            <div
              className={styles.img}
              onClick={() =>
                openCarousel([ProductsOrganico1, ProductsOrganico2])
              }
            >
