...
const HomeNew = () => {
  ...
  return (
    <>
        ...
        <nav className={styles.nav}>
          ...
          <ul className={styles.links}>
            ...
            <li>
              <a
                style={{ cursor: "pointer" }}
                onClick={() => smoothScroll("#product", 130)}
              >
                Produtos
              </a>
            </li>
            <li>
              <a
                style={{ cursor: "pointer" }}
                onClick={() => smoothScroll("#review", 130)}
              >
                Depoimentos
              </a>
            </li>
            <li>
              <a
                style={{ cursor: "pointer" }}
                onClick={() => smoothScroll("#about", 130)}
              >
                Sobre nós
              </a>
            </li>
            <li>
              <a
                style={{ cursor: "pointer" }}
                onClick={() => smoothScroll("#contact", 130)}
              >
                Contato
              </a>
            </li>
      ...
      <section
        className={`${styles.home} ${fade ? "fadeIn" : "fadeOut"}`}
        id="home"
      >
        <div className={styles.imageWrapper}>
          <img
            className={`${styles.fadeInOut} ${styles.backgroundImage}`}
            src={images[index % images.length]}
            alt="Foto do trabalho da Tok Conceito"
          />
        </div>
        ...
        <div className={styles.container_content}>
          <div className={styles.content_text}>
            <h1>
              Um novo conceito em <br /> vestir <span>lares</span>
            </h1>
            <p>
              Na nossa loja, você encontrará produtos de alta qualidade e um
              atendimento personalizado para ajudá-lo a encontrar a solução
              perfeita para a sua decoração.
            </p>
          </div>
        </div>
